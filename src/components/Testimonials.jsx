...
const Testimonials = (props) => {
    ...
    return (
        <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mx-auto mt-10 p-10 transition-all duration-700 rounded-md shadow-purple-300 hover:shadow-xl">
